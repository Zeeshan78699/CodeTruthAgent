...
========================================================================
TEST ID:        TC_M1_003
TITLE:          Robotics Repository Validation
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Robotics-domain repository cognition against a real
    open-source repository.

REPOSITORY:
    rclpy — confirmed 69-repo corpus member

EXPECTED:
    Application Type   = ROBOTICS_SYSTEM (or acceptable variant)
...
TEST_ID   = "TC_M1_003"
REPO_PATH = r"C:\repos\v3\rclpy"
ACCEPTABLE_APPLICATION_TYPES = {"ROBOTICS_SYSTEM"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Robotics Repository Validation",
        "", f"| Field | Value |", f"|---|---|",
        f"| Status | {status} |",
...
def test_tc_m1_003_rclpy_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Robotics Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_003_rclpy_repository()
