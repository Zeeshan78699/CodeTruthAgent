r"""
TC_V2_FINAL_012_BANDIT_DJANGO_COMPARISON
...
CLICK_SOURCE = Path(r"C:\scratch\django\django")

CODETRUTH_REPORT_PATH = Path(
    r"tests/output/v2/django_governance_reports/tc_v2_final_009_report.json"
)
CODETRUTH_REPORT_FALLBACK = Path(
    r"tests/output/v2/django_governance_reports/tc_v2_final_009_report.json"
)

OUTPUT_DIR = Path(r"tests/output/v2/bandit_django_comparison_reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BANDIT_RAW_OUTPUT = OUTPUT_DIR / "bandit_raw_django.json"
COMPARISON_REPORT = OUTPUT_DIR / "tc_v2_final_012_report.json"
...
def main():
    ...
    # ---- Save ----
    final_report = {
        "test_case": "TC_V2_FINAL_012_BANDIT_DJANGO_COMPARISON",
