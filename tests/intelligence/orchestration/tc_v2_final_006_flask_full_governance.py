"""
TC_V2_FINAL_006_FLASK_FULL_GOVERNANCE
...
TARGET_REPO = Path(r"C:\scratch\flask\src\flask")

OUTPUT_DIR = Path(r"tests/output/v2/flask_full_governance_reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

REPORT_FILE = OUTPUT_DIR / "tc_v2_final_006_report.json"
...
def main():
    print("=" * 70)
    print("TC_V2_FINAL_006_FLASK_FULL_GOVERNANCE")
    print("=" * 70)
    ...
    # ---- Save ----
    final = {
        "test_case": "TC_V2_FINAL_006_FLASK_FULL_GOVERNANCE",
