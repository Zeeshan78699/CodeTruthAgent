...
========================================================================
TEST ID:        TC_M1_012
TITLE:          Aviation Repository Validation
GROUP:          B
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Aviation-domain repository cognition.

REPOSITORY:
    dronekit-python — Drone flight control and telemetry
...
TEST_ID   = "TC_M1_012"
REPO_PATH = r"C:\repos\v3\dronekit-python"
ACCEPTABLE_APPLICATION_TYPES = {"AEROSPACE_SYSTEM", "ROBOTICS_SYSTEM", "AVIATION_SYSTEM", "AEROSPACE", "DRONE_UAV"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Aviation Repository Validation",
        "", "| Field | Value |", "|---|---|",
        f"| Status | {status} |",
        f"| Execution Date | {dt.now(UTC).date().isoformat()} |",
        f"| Repository | dronekit-python |",
        "", "## Core",
        "", "| Field | Value |", "|---|---|",
...
def test_tc_m1_012_dronekit_python_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Aviation Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_012_dronekit_python_repository()
