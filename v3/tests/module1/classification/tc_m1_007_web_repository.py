...
========================================================================
TEST ID:        TC_M1_007
TITLE:          Web Application Repository Validation
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Web-domain repository cognition against a real
    open-source repository.

REPOSITORY:
    flask — confirmed 69-repo corpus member

EXPECTED:
    Application Type   = WEB_APPLICATION (or acceptable variant)
...
ACCEPTABLE_APPLICATION_TYPES = {"WEB_APPLICATION"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Web Application Repository Validation",
        "", f"| Field | Value |", f"|---|---|",
        f"| Status | {status} |",
...
def test_tc_m1_007_flask_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Web Application Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_007_flask_repository()
