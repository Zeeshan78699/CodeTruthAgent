"""
TC_V2_FINAL_005_HTTPX_GOVERNANCE
...
TARGET_REPO = Path(r"C:\scratch\httpx\httpx")

OUTPUT_DIR = Path(r"tests/output/v2/httpx_governance_reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

REPORT_FILE = OUTPUT_DIR / "tc_v2_final_005_report.json"
...
def main():
    print("=" * 70)
    print("TC_V2_FINAL_005_HTTPX_GOVERNANCE")
    print("=" * 70)
    ...
    # ---- Save ----
    final = {
        "test_case": "TC_V2_FINAL_005_HTTPX_GOVERNANCE",
