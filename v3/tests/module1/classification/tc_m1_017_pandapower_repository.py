...
========================================================================
TEST ID:        TC_M1_017
TITLE:          Surface Facilities Repository Validation
GROUP:          C
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Surface Facilities-domain repository cognition.

REPOSITORY:
    pandapower — Power grid and surface facility simulation
...
TEST_ID   = "TC_M1_017"
REPO_PATH = r"C:\repos\v3\pandapower"
ACCEPTABLE_APPLICATION_TYPES = {"ENERGY_SYSTEM", "SCIENTIFIC_SYSTEM", "MANUFACTURING_SYSTEM"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Surface Facilities Repository Validation",
        "", "| Field | Value |", "|---|---|",
        f"| Status | {status} |",
        f"| Execution Date | {dt.now(UTC).date().isoformat()} |",
        f"| Repository | pandapower |",
        "", "## Core",
        "", "| Field | Value |", "|---|---|",
...
def test_tc_m1_017_pandapower_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Surface Facilities Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_017_pandapower_repository()
