...
========================================================================
TEST ID:        TC_M1_016
TITLE:          Drilling System Repository Validation
GROUP:          C
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Drilling-domain repository cognition.

REPOSITORY:
    welleng — Wellbore engineering and trajectory calculation
...
TEST_ID   = "TC_M1_016"
REPO_PATH = r"C:\repos\v3\welleng"
ACCEPTABLE_APPLICATION_TYPES = {"ENERGY_SYSTEM", "SCIENTIFIC_SYSTEM", "DRILLING_SYSTEM", "GRAPH_ANALYTICS"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Drilling System Repository Validation",
        "", "| Field | Value |", "|---|---|",
        f"| Status | {status} |",
        f"| Execution Date | {dt.now(UTC).date().isoformat()} |",
        f"| Repository | welleng |",
        "", "## Core",
        "", "| Field | Value |", "|---|---|",
...
def test_tc_m1_016_welleng_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Drilling System Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_016_welleng_repository()
