...
========================================================================
TEST ID:        TC_M1_014
TITLE:          Oil and Gas Repository Validation
GROUP:          B
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Oil and Gas-domain repository cognition.

REPOSITORY:
    lasio — LAS file format for well log data
...
TEST_ID   = "TC_M1_014"
REPO_PATH = r"C:\repos\v3\lasio"
ACCEPTABLE_APPLICATION_TYPES = {"ENERGY_SYSTEM", "SCIENTIFIC_SYSTEM", "OIL_GAS_SYSTEM", "DATA_ENGINEERING"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Oil and Gas Repository Validation",
        "", "| Field | Value |", "|---|---|",
        f"| Status | {status} |",
...
def test_tc_m1_014_lasio_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Oil and Gas Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_014_lasio_repository()
