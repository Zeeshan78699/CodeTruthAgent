"""
TC_V2_FINAL_003 — Governance-on-Scanned-Code Validation
...
OUTPUT_DIR = Path(r"tests/output/v2/governance_wiring_reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

REPORT_FILE = OUTPUT_DIR / "tc_v2_final_003_report.json"
...
def main():
    print("=" * 70)
    print("TC_V2_FINAL_003 — Governance-on-Scanned-Code Validation")
    print("=" * 70)
