...
REPO_ROOT = Path(r"C:\scratch\flask\examples\tutorial")

#OUTPUT_DIR = Path(r"tests/output/v2/dependency_inspection_reports")
OUTPUT_DIR = Path(r"tests/output/v2/flask_cross_repo_reports")
...
def main():
    ...
    # ---- Final report ----
    final_report = {
        "test_case": "TC_V2_FINAL_002c_FLASK_CROSS_REPO",
