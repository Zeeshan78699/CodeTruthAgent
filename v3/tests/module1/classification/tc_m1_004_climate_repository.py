...
========================================================================
TEST ID:        TC_M1_004
TITLE:          Climate Science Repository Validation
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Climate-domain repository cognition against a real
    open-source repository.

REPOSITORY:
    MetPy — confirmed 69-repo corpus member

EXPECTED:
    Application Type   = CLIMATE_SCIENCE_SYSTEM (or acceptable variant)
...
TEST_ID   = "TC_M1_004"
REPO_PATH = r"C:\repos\v3\MetPy"
ACCEPTABLE_APPLICATION_TYPES = {"CLIMATE_SCIENCE_SYSTEM", "SCIENTIFIC_SYSTEM", "CLIMATE_SCIENCE"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Climate Science Repository Validation",
        "", f"| Field | Value |", f"|---|---|",
        f"| Status | {status} |",
...
def test_tc_m1_004_metpy_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Climate Science Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_004_metpy_repository()
