...
========================================================================
TEST ID:        TC_M1_018
TITLE:          Reservoir Engineering Repository Validation
GROUP:          C
MODULE:         Module 1 - Repository Cognition Engine
VERSION:        2.0

OBJECTIVE:
    Validate Reservoir Engineering-domain repository cognition.

REPOSITORY:
    pyreservoir — Reservoir simulation and analysis
...
TEST_ID   = "TC_M1_018"
REPO_PATH = r"C:\repos\v3\pyreservoir"
ACCEPTABLE_APPLICATION_TYPES = {"ENERGY_SYSTEM", "SCIENTIFIC_SYSTEM", "RESERVOIR_SYSTEM", "MONOREPO"}
...
def save_markdown(core, enhanced, passed):
    ...
    lines = [
        f"# {TEST_ID} — Reservoir Engineering Repository Validation",
        "", "| Field | Value |", "|---|---|",
        f"| Status | {status} |",
        f"| Execution Date | {dt.now(UTC).date().isoformat()} |",
        f"| Repository | pyreservoir |",
        "", "## Core",
        "", "| Field | Value |", "|---|---|",
...
def test_tc_m1_018_pyreservoir_repository():
    print("=" * 80)
    print(f"{TEST_ID} — Reservoir Engineering Repository Validation")
    print("=" * 80)
...
if __name__ == "__main__":
    try:
        test_tc_m1_018_pyreservoir_repository()
