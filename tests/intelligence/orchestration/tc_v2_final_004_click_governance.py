"""
TC_V2_FINAL_004_CLICK_GOVERNANCE
...
TARGET_REPO = Path(r"C:\scratch\click\src\click")

OUTPUT_DIR = Path(r"tests/output/v2/click_governance_reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

REPORT_FILE = OUTPUT_DIR / "tc_v2_final_004_click_report.json"
...
def main():
    print("=" * 70)
    print("TC_V2_FINAL_004_CLICK_GOVERNANCE")
    print("=" * 70)
    ...
    # ---- Save ----
    final = {
        "test_case": "TC_V2_FINAL_004_CLICK_GOVERNANCE",
